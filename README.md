# KGCN, KGAT with ComplEx and RotatE
...
* KGAT
```
python main_kgat.py --data_name 'amazon-book' --exp_name "your_exp_name" --train_kg 1 --kg_embedding_type 'complex' --use_pretrain 0```

python main_kgat.py --data_name 'amazon-book' --exp_name "your_exp_name" --train_kg 1 --kg_embedding_type 'rotate' --use_pretrain 0```
```
* KGCN
```
python main_kgcn.py --data_name 'last_fm_new' --exp_name "your_exp_name" --train_kg 1 --kg_embedding_type 'complex' --use_pretrain 0```
```
