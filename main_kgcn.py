...
def parse_kgcn_args():
    ...
    parser.add_argument('--data_name', type=str, default='last_fm_new', help='which dataset to use')
    ...
    parser.add_argument('--train_kg', type=int, default=1,
                        help='train_kg')
    parser.add_argument('--kg_embedding_type', type=str, default='transr',  # complex
                        help='Type of KG Embedding')
